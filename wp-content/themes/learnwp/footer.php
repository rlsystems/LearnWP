                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-6 col-lg-4 mb-6 mb-lg-0">
                            ...
                            <div class="mb-7">
                                <div class="font-size-md font-weight-semibold text-dark mb-4">Main Office</div>
                                <p class="mb-0">
                    ...
                    <div class="footer-last-container position-relative">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-5 mb-3 mb-lg-0">
                                <div>
                                    &copy; 2020 <a href="index.html" class="link-hover-dark-primary font-weight-semibold">RL Systems</a> 
                                </div>
                            </div>
